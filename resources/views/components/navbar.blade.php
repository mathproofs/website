    ...
    <x-container class="flex items-center justify-between py-6">
        ...
        <div class="relative flex justify-end">
            <form method="get" action="{{ route('proofs.search') }}">
                <input type="text" name="query" value="{{ request('query') }}" id="query" class="w-full py-2 pr-4 transition border rounded-md shadow-sm placeholder-stone-500 border-stone-200 focus:placeholder-stone-400 peer focus:ring-1 focus:ring-yellow-500 focus:border-yellow-500 focus:outline-none pl-11" placeholder="Search Proofs" />
            </form>
